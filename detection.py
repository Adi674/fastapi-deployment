...
def run_webcam_detection():
    ...
    while True:
        ...
        # Display anomalies on the frame
        for anomaly in anomalies:
            text = anomaly["anomaly"]
            frame = cv2.putText(frame, text, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)

        # Show live webcam output
    ...
    return anomalies, anomaly_image_path
